...
int main() {
    ...
    CipherModule cipher_module(des_encryptor, key, 64, Mode::CBC, Padding::ISO10126, iv, { 4 });
    ...
    std::string text("../tests/vid.mp4");
    std::string encrypted_text("../tests/c.txt");
    std::string decrypted_text("../tests/d.mp4");

    cipher_module.encrypt_file(text, encrypted_text);
